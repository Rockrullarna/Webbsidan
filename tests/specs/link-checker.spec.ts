...
const startPages = [
  ...
  '/danskurser/',
  '/foreningen/',
  '/foreningen/styrande-dokument/dkrr-001-verksamhetsbeskrivning/',
  '/foreningen/styrande-dokument/dkrr-002-arshjul-och-arbetsprocesser/',
  '/foreningen/styrande-dokument/dkrr-003-stadgar/',
  '/foreningen/styrande-dokument/dkrr-004-organisation-och-rollbeskrivning/',
  '/foreningen/styrande-dokument/dkrr-005-policy-mot-diskriminering/',
  '/foreningen/moten-och-protokoll/',
  '/foreningen/moten-och-protokoll/arsmote/',
  '/kontakt/',
  '/bli-medlem/',
  '/aktivitetskalender/',
];
