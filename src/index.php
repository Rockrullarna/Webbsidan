...
<body>
        ...
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu shadow">
              ...
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="/Tavlingsdans/Kalender">Tävlingskalender</a></li>
              <li><a class="dropdown-item" href="/Tavlingsdans/Vilka-tavlar-vart">Vilka tävlar vart?</a></li>
              <li><a class="dropdown-item" href="/Tavlingsdans/Resultat">Tävlingsresultat</a></li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu shadow">
              ...
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="https://www.google.se/maps/place/Rockrullarna+i+%C3%96rebro/@59.2747154,15.1734813,14.12z/data=!4m5!3m4!1s0x465c14d4a35b37db:0x948d71326b2d8b7c!8m2!3d59.2754033!4d15.1647323" title="Hitta till oss (Google maps öppnas i nytt fönster)">Hitta till oss (Google maps)</a></li>
              <li><a class="dropdown-item" href="https://m.me/Rockrullarna" title="Chatta med oss (Messenger öppnas i nytt fönster)" title="_blank">Chatta med oss (Messenger)</a></li>
              <li><hr class="dropdown-divider"></li>
              <li class="dropstart">
  ...
  <footer class="row">
      ...
      <div id="footer-social" class="col-lg-4 col-xl-3 text-center align-self-end p-0 mt-3">
