...
* dokument (tomt, då denna mappen ignoreras i .gitignore)
  ...
  * Styrande dokument (Ligger under mappen: [Styrande dokument](https://github.com/Rockrullarna/Webbsidan/tree/main/src/foreningen/styrande-dokument/) och dess undermappar)
* js (javascript)
