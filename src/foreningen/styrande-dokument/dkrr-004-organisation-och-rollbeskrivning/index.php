<?php
  ...
  ?>
    ...
    <p>Öppna dokumentet i nytt fönster: <br />
      <a href="DKRR-004-Organisation-och-rollbeskrivning_v1.0.pdf"><img src="/filer/bilder/design/extension-pdf.gif" width="18" height="18" /> DKRR-004 Organisation och rollbeskrivning_v1.0.pdf</a><br />
      Eller läs det här nedan.</p>
    <iframe src="DKRR-004-Organisation-och-rollbeskrivning_v1.0.pdf"  style="width: 98%; min-width: 320px; height: 600px"></iframe>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
<?php
