...
?>
    ...
    <ul>
      <li>Vad diskriminering, sexuellt ofredande, kränkning och särbehandling är.</li>
      <li>Hur man som utsatt/vittne bör agera.</li>
    ...
    <ul>
      ...
      <li>Alla medlemmar samt anhöriga till barn/ungdom ska veta att denna policy existerar samt vart den finns tillgänglig.</li>
      <li>Alla medlemmar samt anhöriga till barn/ungdom förväntas agera utifrån denna policy.</li>
    ...
    <h2>Definitioner och begreppsförklaring</h2>
    ...
    <h3>Mobbing/kränkande behandling</h3>
    ...
    <h3>Trakasserier/diskriminering</h3>
    ...
    <ul>
      ...
      <li>Ledningen arbetar för att vara uppmärksamma, lyhörda och verka för en öppen, positiv atmosfär där alla känner sig delaktiga och lyssnade på.</li>
      <li>Aktivt arbeta med uppfyllnad av denna policy:
        <ul>
          <li>Styrelsen och övriga ansvarsroller träffas minst en gång per år för att bland annat diskutera uppfyllnad av denna policy.</li>
          <li>Tränare samlas efter kurstillfällen och diskuterar om någonting har uppmärksammats.</li>
        </ul>
      </li>
    ...
    <p> </p>
    <ul>
    <li><b>Aktivt ta ställning</b></li>
    </ul>
    <p>Att aktivt ta ställning i vardagen och säga ifrån när du ser och hör något som du tycker är fel kan stärka andra att våga göra detsamma. Att stå bredvid och titta på kan vara lika illa som att utsätt.</p>
    <ul>
    <li><b>Ta konflikt i egna händer</b></li>
    </ul>
    <p>Om du upplever att du har blivit illa behandlad uppmanar vi dig att prata med den person som du har blivit illa behandlad av. På ett behärskat och kontrollerat sätt, förklara vad som uppfattades som stötande. Att prata negativt om någon som du har en konflikt med färgar av sig på människor i din närhet och bidrar ofta till att konflikten växer. Prata direkt med personen du är oense med istället.</p>
    <p>Observera att ovanstående är en uppmaning i de fall där händelsen inte rubriceras som ett lagbrott.</p>
    <p>Att reflektera över: Hur pratar jag/hur bör jag prata med andra människor under en pågående konflikt?</p>
    <ul>
    <li><b>Kontakta styrelsen eller annan ansvarsroll</b></li>
    </ul>
    <p>Du ska alltid känna dig trygg att kontakta styrelsen eller valfri person som innehar en ansvarsroll i föreningen. Det finns många anledningar att personer undviker att ta konflikter i egna händer och det är helt förståelig.</p>
    ...
    <p> </p>
    <h2>Handlingsplan styrelse</h2>
    <ul>
    <li><b>Skaffa en bild av läget</b></li>
    </ul>
    <p>Ta reda på vad som har hänt? Vilka är inblandade? Vad är nulägesbilden?<br />Undvika att genomföra någon åtgärd innan kategorisering av händelse är utförd.</p>
    <ul>
    <li><b>Kategorisering av händelse</b></li>
    </ul>
    <p>Om händelsen rubriceras som brott ska polisanmälan göras. I det fall som händelsen är svårbedömd som lagbrott eller ej ska polisen kontaktas för rådgivning.</p>
    <p>I de fall händelsen inte är ett lagbrott ska identifiering göras om det kan vara ett brott mot föreningens stadgar och policys.</p>
    <p>Om händelsen varken är ett lagbrott eller stadgebrott hanteras ärendet av föreningen för att reda ut och lösa situationen.</p>
    <ul>
    <li><b>Egen åtgärd</b></li>
    </ul>
    <p>Vi händelse av egna åtgärder genomförs samtal med inblandade där konsekvenser förklararnas om ingen ändring sker. Samtal genomförs av klubbens styrelse och, vid behov, externt stöd från SISU-idrottsutbildarna. Åtgärder ska alltid göras i samverkan med den utsatte.</p>
    <p>Om förändring inte sker beslutar föreningens styrelse om åtgärd vilket exempelvis kan leda till fråntagande av uppdrag eller att medlem/medlemmar stängs av från föreningen.</p>
