<?php
  $header_title = "Årshjulet - Styrande dokument - Föreningen";
...
?>
    <div id="BreadCrumbsDiv">
      <a href="../../../">Rockrullarna.se</a> / <a href="../../">Föreningen</a> / <a href="../">Styrande dokument</a> / <span>Årshjul</span>
    </div>
    <h1>
      DKRR Årshjul
    </h1>
    ...
    <p>
      ...
      <a href="DKRR-002-v1.0-Årshjul.pdf"><img src="/filer/bilder/design/extension-pdf.gif" width="18" height="18" /> DKRR-002-v1.0-Årshjul.pdf</a><br />
      Eller läs det här nedan.
    </p>
    <iframe src="DKRR-002-v1.0-Årshjul.pdf"  style="width: 98%; min-width: 320px; height: 600px"></iframe>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
<?php
