...
<head>
  ...
  <title>Trivselkvällar - Kursöversikt - Rockrullarna.se</title>
...
<body>
  ...
  <main>
    ...
    <p>
      För att skapa gemenskap och trivsel samt att ge allmänheten en möjlighet att ta del av DK Rockrullarnas verksamhet, anordnas varje månad en trivselkväll.
    </p>
    <p>
    ...
    <ul>
      <li><strong>Medlem</strong>: Fritt inträde</li>
      <li><strong>Ej medlem</strong>: 40 SEK</li>
    </ul>
