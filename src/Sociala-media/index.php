...
?>
    ...
    <p>
      Här finns information från våra sociala media.
    </p>
    <h2>
      <svg width="16" height="16" fill="currentColor" class="bi bi-facebook"><use href="#facebook"></use></svg> Facebook
    </h2>
    <p>
    ...
    <h2>
      <svg width="16" height="16" fill="currentColor" class="bi bi-tiktok"><use href="#instagram"></use></svg> Instagram
    </h2>
    <p>
      <a href="https://www.instagram.com/rockrullarna" title="Rockrullarna på instagram">instagram.com/rockrullarna</a>
    </p>
    <h2>
      <svg width="16" height="16" fill="currentColor" class="bi bi-tiktok"><use href="#tiktok"></use></svg> Tik-Tok
    </h2>
