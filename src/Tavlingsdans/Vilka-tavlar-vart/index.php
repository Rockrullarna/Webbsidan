...
?>
    ...
    <p>
      <iframe frameborder="0" height="1000" marginheight="0" marginwidth="0" src="https://dans.se/tools/comp/registrations/?org=ROCKRULLARNA"  style="width: 98%; min-width: 320px;"></iframe>
    </p>
    <p>
